...
const statusUpdates = [
    ...
    { title: 'Uke 47 Komponentbiblioteket', desc: 'I Simons siste uke jobbet han med å få inn noen siste komponenter, men også på å forenkle demoer, forbedre dokumentasjon og generell ferdigstilling av prosjektet, slik at det blir enklere for noen å ta det over.', highlight: 'Komponenter: Breadcrumb, Banner, Calendar' }
    ];
