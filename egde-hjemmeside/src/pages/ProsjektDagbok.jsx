...
const statusUpdates = [
    ...
    { title: 'Uke 46 Komponentbiblioteket', desc: 'I Idas siste uke ferdigstilte vi de siste komponentene og gjorde små justeringer etter tilbakemeldinger. Vi oppdaterte dokumentasjonen og hadde et avsluttende møte med veilederen vår, der vi oppsummerte erfaringene fra praksisperioden.', highlight: 'Komponenter: Blockquote, Popover, Menu-bar, Copy-button' },
    { title: 'Uke 47 Komponentbiblioteket', desc: 'I Simons siste uke jobbet han med å få inn noen siste komponenter, men også på å forenkle demoer, forbedre dokumentasjon og generell ferdigstilling av prosjektet, slik at det blir enklere for noen å ta det over.', highlight: 'Komponenter: Breadcrumb, Banner, Calendar, Counter, Drawer' }
    ];
